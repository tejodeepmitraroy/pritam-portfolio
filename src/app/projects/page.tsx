...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "An intuitive dashboard for financial data visualization and analysis.",
    ...
    },
    {
      title: "Travel App",
      description:
        "A mobile application for travel planning and booking with personalized recommendations.",
      category: "Mobile App",
      year: "2022",
    },
    {
      ...
      description:
        "A patient-centered healthcare portal for managing appointments and medical records.",
      category: "Web Application",
      year: "2021",
    },
    {
      ...
      description:
        "An integrated system for controlling and monitoring smart home devices.",
      category: "IoT",
      year: "2021",
    },
    {
      ...
      description:
        "An online learning platform with interactive courses and progress tracking.",
      category: "Web Application",
      year: "2020",
    },
  ];
